 ...
 */
public class SociteyFragment extends Fragment implements MainContract.View {


    public SociteyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_socitey,container,false);
    ...
    private void initData() {
        presenter.requestData(utils.socitey,utils.key);
    }
